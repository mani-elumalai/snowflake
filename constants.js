...
export const categoryColorScale = d3.scaleOrdinal()
  ...
  export const titles = [
    { label: 'Associate Engineer', minPoints: 0, maxPoints: 35 },
    { label: 'Software Engineer', minPoints: 36, maxPoints: 57 },
    { label: 'Senior Software Engineer', minPoints: 36, maxPoints: 57 },
    { label: 'Lead Software Engineer', minPoints: 58, maxPoints: 89 },
